...
namespace Academy
{
	internal class Student: Human
	{
		...
		public Student(Student other):base(other)
		{
            ...
            Console.WriteLine($"SCopyConstuctor:{this.GetHashCode()}");
        }
		
		~Student()
		{
            Console.WriteLine($"SDonstructor:\t {this.GetHashCode()}");
        }
		...
		public override void Init(string[] values)
		{
			...
			Rating = Convert.ToDouble(values[6].TrimStart().TrimEnd());
			Attendance = Convert.ToDouble(values[7].TrimStart().TrimEnd());
		}
